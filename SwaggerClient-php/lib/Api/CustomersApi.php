...
class CustomersApi
{
    ...
    /**
     * Operation getAllWithTrashedCustomers
     *
     ...
     */
    public function getAllWithTrashedCustomers()
    {
        list($response) = $this->getAllWithTrashedCustomersWithHttpInfo();
        return $response;
    }

    /**
     * Operation getAllWithTrashedCustomersWithHttpInfo
     *
     * Retrieve all customer including any deleted models
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAllWithTrashedCustomersWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/customer/all-with-trashed";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
