...
class RefundApi
{
     ...
     */
    public function addRefund($booking_id, $paymentgateway_id, $amount)
    {
        list($response) = $this->addRefundWithHttpInfo($booking_id, $paymentgateway_id, $amount);
        return $response;
    }

    /**
     * Operation addRefundWithHttpInfo
     *
     * Create a new refund
     *
     * @param int $booking_id  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function addRefundWithHttpInfo($booking_id, $paymentgateway_id, $amount)
    {
        // verify the required parameter 'booking_id' is set
        if ($booking_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $booking_id when calling addRefund');
        }
        // verify the required parameter 'paymentgateway_id' is set
        if ($paymentgateway_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $paymentgateway_id when calling addRefund');
        }
        // verify the required parameter 'amount' is set
        if ($amount === null) {
            throw new \InvalidArgumentException('Missing the required parameter $amount when calling addRefund');
        }
        // parse inputs
        $resourcePath = "/refund/add";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse2012', $httpHeader), $statusCode, $httpHeader);
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function filterRefunds($after = null, $before = null)
    {
        list($response) = $this->filterRefundsWithHttpInfo($after, $before);
        return $response;
    }

    /**
     * Operation filterRefundsWithHttpInfo
     *
     * Retrieve all refunds that match a filter
     *
     * @param \DateTime $after Date of the earliest payment (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function filterRefundsWithHttpInfo($after = null, $before = null)
    {
        // parse inputs
        $resourcePath = "/refund/filter";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20039', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20039', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 422:
    ...
    {
        list($response) = $this->getAllRefundsWithHttpInfo();
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getAllRefundsWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/refund/all";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\InlineResponse20038', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\InlineResponse20038', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
